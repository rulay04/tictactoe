...
function TicTacToe() {
    ...
    // define what you will be tracking
    // create tiles and default state should be array of 9 null (board tiles)
    const [tiles, setTiles] = useState(Array(9).fill(null));
    // track if it is x or o's turn and default to x
    ...
    const handleTileClick = (index) => {
        ...
        // set the tile to the players turn
        newTiles[index] = playerTurn;
        // make the new tiles the new state
        setTiles(newTiles);
    ...
    return (
        <div>
            <h1>Tic Tac Toe</h1>
            {/* Pass tiles to board as property tiles*/}
